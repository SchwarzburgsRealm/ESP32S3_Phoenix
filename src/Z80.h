...
#define LSB_FIRST              /* ESP32 is little-endian */
...
// word type - DISABLED to avoid conflict with Arduino.h
// Use uint16_t directly in your code
...
/*************************************************************/
void IntZ80(register Z80 *R,register uint16_t Vector);
...
/*************************************************************/
#ifndef EXECZ80
uint16_t RunZ80(register Z80 *R);
#endif
...
void WrZ80(register uint16_t Addr,register byte Value);
byte RdZ80(register uint16_t Addr);
...
/************************************ TO BE WRITTEN BY USER **/
void OutZ80(register uint16_t Port,register byte Value);
...
/************************************ TO BE WRITTEN BY USER **/
uint16_t LoopZ80(register Z80 *R);
